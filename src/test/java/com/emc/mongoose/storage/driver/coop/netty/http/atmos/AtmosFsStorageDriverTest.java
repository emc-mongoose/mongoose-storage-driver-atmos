...
public class AtmosFsStorageDriverTest extends AtmosStorageDriver {
	...
	private AtmosFsStorageDriverTest(final Config config) throws Exception {
		super(
	...
	public void testRequestNewAuthToken() throws Exception {
		...
		assertEquals(
						"PUT\n\n\n"
										...
										+ SUBTENANT_URI_BASE
										+ "\n"
										+ EmcConstants.KEY_X_EMC_FILESYSTEM_ACCESS_ENABLED
										+ ":true\n"
